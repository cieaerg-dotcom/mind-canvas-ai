...
with st.sidebar:
    ...
    st.header("🧠 模型設定")
    target_chat_models = ["gemini-3.1-pro-preview", "gemini-3.1-flash-lite-preview", "gemini-3-flash-preview",  "gemini-3-pro-preview", "gemini-2.5-flash", "gemini-2.5-flash-lite", "gemini-2.5-pro"]
    target_img_models = ["gemini-3.1-flash-image-preview", "gemini-3-pro-image-preview", "gemini-2.5-flash-image", "imagen-4.0-generate-001", ]
        ...
        with st.chat_message("assistant"):
            try:
                ...
                resp = client.models.generate_content(
                    model=selected_chat_model, # [MODIFIED]
                ...
                update_canvas_summary(client, "\n".join([m['content'] for m in st.session_state.messages]), selected_chat_model) # [MODIFIED]
                st.rerun()
